                        ...
                        <div class="nav-align-top mb-4">
                            ...
                            <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input id="input_post_title" name="title" type="text" placeholder="" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $product['title']) }}" />
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="input_post_city" name="city" type="text" placeholder="" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $product['city'] ) }}" />
                                    @error('city')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="input_post_image" name="image" value="{{ old('image', $product['image']) }}" type="text" class="form-control @error('images1') is-invalid @enderror" placeholder="" readonly />
                                        @error('image')
                                        <span class="invalid-feedback" role="alert">
